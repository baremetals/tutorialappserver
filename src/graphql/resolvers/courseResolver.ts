...
import { createCourse, deleteCourse, editCourse, getCourseBySlug, getCoursesByCategoryId, getLatestCourses, getStudentsByCourseId } from "../../controllers/CourseController";
...
const courseResolver = {
  ...
  Query: {
    getCourseBySlug: async (
      ...
      try {
        course = await getCourseBySlug(args.slug);
